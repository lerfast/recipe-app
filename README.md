...
Using SSH-key:
```
git clone git@github.com:lerfast/recipe-app.git
```

Using HTTPS:

```
git clone https://github.com/lerfast/recipe-app.git
```
You can also create the new directory just adding the name of it in the end of command. For example:

```
git clone https://github.com/lerfast/recipe-app.git catalog
```
